...
const CheckoutPage = () => {
  ...
  return (
    <div
      className="min-h-screen bg-[#fdfaf7] pb-20"
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <div>
            <h1 className="text-3xl font-black text-[#3b2a20] tracking-tight">
              Xác nhận thanh toán
            </h1>
            <p className="text-[#8b735b]">
              Vui lòng kiểm tra lại thông tin và địa chỉ giao hàng
            </p>
          </div>
        </motion.div>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-[#3b2a20]">
                  Địa chỉ giao hàng
                </h3>
              </div>
              ...
              <div className="mt-4 flex items-start gap-2 text-sm text-[#8b735b] bg-[#d4a373]/5 p-4 rounded-xl">
                ...
                <p>
                  Đảm bảo địa chỉ chính xác để shipper có thể liên lạc và giao
                  hàng đúng hẹn cho bạn nhé!
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="p-4 border-2 border-[#d4a373] bg-[#d4a373]/5 rounded-2xl flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <img
                    src="https://img.vietqr.io/image/970422-0977958350-compact2.jpg?amount=0&addInfo=Payment&accountName=HUYNH%20TAN%20LOC"
              ...
              <div className="space-y-4 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar mb-6">
                {isCart ? (
                  cartData.cartProductEntities.map((item, idx) => (
                    <div
                      key={idx}
                      className="flex gap-4 items-center py-3 border-b border-white/10"
                    >

      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl bg-neutral-950 border border-neutral-800 rounded-[2.5rem] shadow-[0_0_100px_rgba(0,0,0,0.5)] z-[1000] overflow-hidden flex flex-col max-h-[85vh]"
            ...
            <div className="px-8 py-8 overflow-y-auto space-y-8 custom-scrollbar">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="p-5 rounded-[2rem] bg-neutral-900 border border-neutral-800 flex flex-col items-center justify-center text-center space-y-1">
                  <p className="text-[10px] font-black text-neutral-500 uppercase tracking-widest">Số lượng</p>
                  <p className="text-xl font-black text-white">{order.quantity || 0}</p>
                  <p className="text-[10px] text-neutral-600 font-bold uppercase">Sản phẩm</p>
                </div>
                    ...
                    order.orderDetailsDTOS.map((item, idx) => (
                      ...
                      >
                        <div className="flex gap-5">
                          <div className="w-12 h-12 rounded-2xl bg-neutral-800 border border-neutral-700 flex items-center justify-center shrink-0 font-black text-orange-500 text-lg">
                            {item.quantity}
                          </div>
